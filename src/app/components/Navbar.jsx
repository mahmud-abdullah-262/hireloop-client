    ...
    <nav className="w-full bg-[#111111] text-[#E5E5E5] px-6 border-b border-zinc-800">
      ...
      {isOpen && (
        <div className="md:hidden mt-4 bg-[#1A1A1A] border border-zinc-800 rounded-2xl p-4 flex flex-col space-y-4 text-sm font-medium text-zinc-300">
          <Link href="#" className="hover:text-white py-1 border-b border-zinc-800/50">Browse Jobs</Link>
          <Link href="#" className="hover:text-white py-1 border-b border-zinc-800/50">Company</Link>
          <Link href="#" className="hover:text-white py-1">Pricing</Link>
          
          <div className="pt-2 flex flex-col space-y-3">
            <Link href="/signin" className="text-indigo-400 text-center hover:text-indigo-300 py-2">
              Sign In
            </Link>
            <Link href="signup" className="bg-white text-black text-center font-semibold py-2.5 rounded-xl">
              Get Started
            </Link>
          </div>
        </div>
